        ...
        step: [
          {
            ...
            text: "Go to https://thepdftools.site/qr-generator and open the free QR code creator.",
          },
          {
            "@type": "HowToStep",
            position: 2,
            name: "Choose QR code type",
            text: "Select URL, plain text, Wi-Fi credentials, email, or phone number.",
          },
          {
            "@type": "HowToStep",
            position: 3,
            name: "Enter the content",
            text: "Type or paste the information you want the QR code to contain.",
          },
          {
            "@type": "HowToStep",
            position: 4,
            name: "Customize the QR code",
            text: "Adjust size, error correction level, and color as needed.",
          },
          {
            "@type": "HowToStep",
            position: 5,
            name: "Download the QR code",
            text: "Click Download to save the QR code as a PNG or SVG image.",
          }
        ],
      },
