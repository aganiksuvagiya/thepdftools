  ...
  return (
    <div className="card space-y-6">
      <DropZone
        ...
        sublabel="JPG or JPEG only · Click to browse"
      />
        ...
        <>
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            <div className="space-y-3">
              <p className="text-sm font-medium text-gray-700">Original (JPG)</p>
              <div className="overflow-hidden rounded-xl border border-gray-100">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src={preview}
                  alt="original JPG before PNG conversion"
            ...
            <div className="space-y-3">
              ...
              <div className="min-h-[12rem] overflow-hidden rounded-xl border border-gray-100 flex items-center justify-center bg-gray-50">
                {result ? (
                  ...
                  <img
                    src={result.url}
                    alt="converted PNG image online free fast"
              ...
              {result && (
                <div className="rounded-xl bg-brand-50 border border-brand-100 p-3 text-center">
                  <p className="text-xs text-brand-600">PNG size</p>
