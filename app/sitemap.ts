...
const EXACT_RULES: Record<string, RouteRule> = {
  ...
  "/pdf-compress": { changeFrequency: "weekly", priority: 0.93 },
  "/pdf-merge": { changeFrequency: "weekly", priority: 0.93 },
  "/pdf-split": { changeFrequency: "weekly", priority: 0.93 },
  "/pdf-to-word": { changeFrequency: "weekly", priority: 0.91 },
  "/pdf-to-excel": { changeFrequency: "weekly", priority: 0.9 },
  "/pdf-to-jpg": { changeFrequency: "weekly", priority: 0.9 },
  "/pdf-to-image": { changeFrequency: "weekly", priority: 0.89 },
  "/word-to-pdf": { changeFrequency: "weekly", priority: 0.9 },
  "/excel-to-pdf": { changeFrequency: "weekly", priority: 0.89 },
  "/ppt-to-pdf": { changeFrequency: "weekly", priority: 0.88 },
  "/html-to-pdf": { changeFrequency: "weekly", priority: 0.88 },
  "/markdown-to-pdf": { changeFrequency: "weekly", priority: 0.87 },
  "/text-to-pdf": { changeFrequency: "weekly", priority: 0.87 },
  "/screenshot-to-pdf": { changeFrequency: "weekly", priority: 0.87 },
  "/image-to-pdf": { changeFrequency: "weekly", priority: 0.89 },
  "/jpg-to-pdf": { changeFrequency: "weekly", priority: 0.89 },
  "/scanned-pdf-to-searchable-pdf": { changeFrequency: "weekly", priority: 0.89 },
  "/compress-pdf-to-100kb": { changeFrequency: "weekly", priority: 0.9 },
  "/compress-pdf-to-200kb": { changeFrequency: "weekly", priority: 0.9 },
  "/compress-pdf-for-govt-exam": { changeFrequency: "weekly", priority: 0.9 },
  "/reduce-pdf-size-online-free": { changeFrequency: "weekly", priority: 0.89 },
  "/png-to-jpg": { changeFrequency: "weekly", priority: 0.88 },
  "/png-to-jpg-for-photos": { changeFrequency: "weekly", priority: 0.87 },
  "/png-to-jpg-white-background": { changeFrequency: "weekly", priority: 0.87 },
  "/jpg-to-png": { changeFrequency: "weekly", priority: 0.88 },
  "/jpg-to-png-no-upload": { changeFrequency: "weekly", priority: 0.87 },
  "/jpg-to-png-for-logos": { changeFrequency: "weekly", priority: 0.87 },
  "/image-compressor": { changeFrequency: "weekly", priority: 0.9 },
  "/image-resizer": { changeFrequency: "weekly", priority: 0.86 },
  "/image-cropper": { changeFrequency: "weekly", priority: 0.86 },
  "/image-rotate": { changeFrequency: "weekly", priority: 0.85 },
  "/image-watermark": { changeFrequency: "weekly", priority: 0.85 },
  "/image-upscaler": { changeFrequency: "weekly", priority: 0.85 },
  "/image-to-webp": { changeFrequency: "weekly", priority: 0.86 },
  "/background-remover": { changeFrequency: "weekly", priority: 0.88 },
  "/svg-to-png": { changeFrequency: "weekly", priority: 0.84 },
  "/heic-to-jpg": { changeFrequency: "weekly", priority: 0.85 },
  "/video-to-gif": { changeFrequency: "weekly", priority: 0.84 },
  "/compress-image-to-100kb": { changeFrequency: "weekly", priority: 0.86 },
  "/json-formatter": { changeFrequency: "weekly", priority: 0.82 },
  "/csv-to-json": { changeFrequency: "weekly", priority: 0.82 },
  "/base64": { changeFrequency: "weekly", priority: 0.81 },
  "/url-encoder": { changeFrequency: "weekly", priority: 0.81 },
  "/regex-tester": { changeFrequency: "weekly", priority: 0.81 },
  "/timestamp-converter": { changeFrequency: "weekly", priority: 0.81 },
  "/tailwind-colors": { changeFrequency: "weekly", priority: 0.8 },
  "/color-picker": { changeFrequency: "weekly", priority: 0.81 },
  "/color-gradient": { changeFrequency: "weekly", priority: 0.8 },
  "/favicon-generator": { changeFrequency: "weekly", priority: 0.8 },
};
