    ...
    "@graph": [
      {
        ...
        description: "Extract pages or split a PDF into separate files for free in your browser.",
        step: [
          {
            "@type": "HowToStep",
            position: 1,
            name: "Open the PDF Split tool",
            text: "Go to https://thepdftools.site/pdf-split and open the free PDF splitter.",
          },
          {
            "@type": "HowToStep",
            position: 2,
            name: "Upload your PDF",
            text: "Click the upload area or drag and drop the PDF you want to split.",
          },
          {
            "@type": "HowToStep",
            position: 3,
            name: "Choose split mode",
            text: "Select split by page range, extract specific pages, or split into individual pages.",
          },
          {
            "@type": "HowToStep",
            position: 4,
            name: "Apply the split",
            text: "Click Split PDF to process the document according to your chosen settings.",
          },
          {
            "@type": "HowToStep",
            position: 5,
            name: "Download the result",
            text: "Download the extracted pages or split files to your device.",
          }
        ],
      },
      {
        ...
        { "@type": "ListItem", "position": 3, "name": "PDF Split", "item": "https://thepdftools.site/pdf-split" },
        ],
      },
    ],
  };
