    ...
    "@graph": [
      {
        ...
        description: "Remove the background from a photo or product image using AI — free, in your browser.",
        step: [
          {
            "@type": "HowToStep",
            position: 1,
            name: "Open the Background Remover",
            text: "Go to https://thepdftools.site/background-remover and open the free AI background remover.",
          },
          {
            "@type": "HowToStep",
            position: 2,
            name: "Upload your image",
            text: "Click the upload area or drag and drop a JPG or PNG image.",
          },
          {
            "@type": "HowToStep",
            position: 3,
            name: "Process with AI",
            text: "The AI model automatically detects and removes the background from the image.",
          },
          {
            "@type": "HowToStep",
            position: 4,
            name: "Download the result",
            text: "Click Download to save the image with a transparent background as a PNG file.",
          }
        ],
      },
      {
        ...
        { "@type": "ListItem", "position": 3, "name": "Background Remover", "item": "https://thepdftools.site/background-remover" },
        ],
      },
    ],
  };
